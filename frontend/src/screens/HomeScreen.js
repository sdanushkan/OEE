    ...
    <div className='h-fit w-full flex flex-col'>
        <div className='h-[400px] w-full flex flex-col md:flex-row items-center justify-center relative '>
                ...
                <div className='h-full w-full absolute z-30 bg-gradient-to-b from-transparent to-black/75 flex flex-col items-center justify-center px-[25px] md:px-0'>
                    <p className=' text-4xl md:text-5xl text-left md:text-center font-medium max-w-[600px] text-white'>Overseas Education Experts</p>
                    <p className=' text-xl text-left md:text-center max-w-[625px] text-white capitalize'> — Building Bridges to a World-Class Education—</p> 
                </div>
            </div>
