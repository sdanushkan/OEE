...
{/* 
            ...
            <button className='h-[100px] md:h-[50px] w-full overflow-hidden focus:overflow-hidden bg-white  focus:h-fit duration-200 px-[15px] md:px-[35px]'>
              ...
              <div className='bg-blue-500 text-white py-[15px] md:py-[25px] px-[15px] md:px-[35px]'>
                <ol className='list-disc md:px-[25px]'>
                  <li className='text-left'>High-Quality Education: Switzerland is known for its world-class education system and globally recognized institutions.</li>
                  <li className='text-left'>Diverse and Inclusive Society: Switzerland is welcoming and multicultural, making it an excellent place for international students to adapt and thrive.</li>
                  <li className='text-left'> Post-Graduate Work Opportunities: Switzerland provides opportunities for international students to gain valuable work experience through post-graduate work permits.</li>
                  <li className='text-left'> Safety and Quality of Life: Switzerland is consistently ranked as one of the safest countries in the world, offering an excellent quality of life.</li>
                  ...
                  <li className='text-left'>Natural Beauty: Switzerland's stunning landscapes and outdoor activities make it an ideal destination for those who enjoy the outdoors.</li>
                  <li className='text-left'>Language Learning: Studying in Switzerland allows you to improve your language skills, with English and French as the official languages.</li>
                  <li className='text-left'> Healthcare Benefits: International students often have access to Switzerland's healthcare system, which is highly regarded.</li>
                  <li className='text-left'> Immigration Opportunities: Switzerland offers various pathways for international students to become permanent residents or citizens.</li>
                  <li className='text-left'>Networking and Cultural Experiences: Studying in Switzerland enables you to build a global network and experience diverse cultures.</li>
